...
const referenceMenus: ReferenceMenu[] = [
  ...
  },
  {
    name: '销售',
    groups: [
      { name: '批发业务', items: entries([['报价单', '/inv/invBjd/list', '/sales/quotes'], ['网店订单', '/inv/invWddd/list?shzt=&ddzt=', '/sales/online-orders'], ['销售订单', '/inv/invXsdd/list?shzt=&ddzt=', '/sales/orders'], ['销售单', '/inv/invXsd/list?shzt=&ddzt=', '/sales/bills'], ['销售退货单', '/inv/invXsth/list?shzt=&ddzt=', '/sales/returns'], ['销售返修单', '/inv/xsfxd/list', '/sales/repairs'], ['销售发票登记', '/inv/xsdkp/list'], ['销售回款情况', '/inv/xshk/list']]) },
